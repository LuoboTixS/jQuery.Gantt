...
return"rgb("+o+", "+n+", "+r+")";}catch(p){return"";}};a.each(j.data,function(n,o){switch(e.multiTaskPerRow){case true:a.each(o.values,function(q,z){if(o.values[q].cat<=((j.pageNum+1)*e.rowsPerPage-1)&&(o.values[q].cat>(j.pageNum*e.rowsPerPage-1))){var E=null;
